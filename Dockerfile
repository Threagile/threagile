...
COPY --from=build /app/render-data-asset-diagram.sh /app/render-data-asset-diagram.sh
COPY --from=build /app/render-data-flow-diagram.sh /app/render-data-flow-diagram.sh
