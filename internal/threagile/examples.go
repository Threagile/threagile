...
var createExampleModelCmd = &cobra.Command{
...
var createStubModelCmd = &cobra.Command{
...
var createEditingSupportCmd = &cobra.Command{
...
func init() {
	rootCmd.AddCommand(createExampleModelCmd)
	rootCmd.AddCommand(createStubModelCmd)
	rootCmd.AddCommand(createEditingSupportCmd)
}
