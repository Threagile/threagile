...
func (what *Threagile) initCreate() *Threagile {
	what.rootCmd.AddCommand(&cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			err = common.CreateExampleModelFile(appDir, outDir)
			if err != nil {
	...
	what.rootCmd.AddCommand(&cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			err := common.CreateStubModelFile(cfg.AppFolder, cfg.OutputFolder)
			if err != nil {
	...
	what.rootCmd.AddCommand(&cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			err = common.CreateEditingSupportFiles(appDir, outDir)
			if err != nil {
