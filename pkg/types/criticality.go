...
func init() {
	yaml.RegisterCustomMarshaler[Criticality](func(what Criticality) ([]byte, error) {
		return []byte(what.String()), nil
	})

	yaml.RegisterCustomUnmarshaler[Criticality](func(what *Criticality, data []byte) error {
