...
func TestNotEqualExpression_EvalBool_DifferentStrings_ReturnsTrue(t *testing.T) {
...
func TestNotEqualExpression_EvalBool_EqualStrings_ReturnsFalse(t *testing.T) {
	scope := new(common.Scope)
	_ = scope.Init(nil, nil)
