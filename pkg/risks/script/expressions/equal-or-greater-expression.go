...
func (what *EqualOrGreaterExpression) EvalBool(scope *common.Scope) (bool, string, error) {
...
func (what *EqualOrGreaterExpression) EvalAny(scope *common.Scope) (any, string, error) {
