...
func createRiskTechAsset(technicalAsset types.TechnicalAsset) types.Risk {
...
func createRiskCommLink(technicalAsset types.TechnicalAsset, commLink types.CommunicationLink) types.Risk {
